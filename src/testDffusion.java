...
public class testDffusion extends PApplet {
	/**
	 * 
	 */
	...
	/**
	 * <p>
	 * GrayScottImage uses the seedImage() method to use a bitmap as simulation
	 * seed. In this demo the image is re-applied every frame and the user can
	 * adjust the F coefficient of the reaction diffusion to produce different
	 * patterns emerging from the boundary of the bitmapped seed. Unlike some
	 * other GS demos provided, this one also uses a wrapped simulation space,
	...
	public void setup() {
		...
		img = loadImage("C:/Users/Administrator/Pictures/xueba2.png");
		...
		gs.setCoefficients(0.025f,0.069f,0.095f,0.03f);
			...
			for (int j = numh; j > 0; j--) {
				this.output
						.println("["
								...
								+ j
								+ "]:"
								+ gs.getCurrentVAt(i * width / numw, j * height
										/ numh));
			}
		}
